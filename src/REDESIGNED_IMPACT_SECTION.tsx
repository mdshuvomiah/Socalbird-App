      {/* Real Impact Section - Modern Showcase */}
      <section className="py-24 px-4 border-t border-white/10 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-purple-500 rounded-full blur-3xl animate-pulse delay-75" />
        </div>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-full mb-6">
              ...
              <span className="text-sm font-semibold text-cyan-300">Real Results, Real Growth</span>
            </div>
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              From startups to growing businesses - we've helped companies 3X their revenue, automate support, and scale faster
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
            {[
              ...
              { 
                ...
                sublabel: 'Still working with us',
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${stat.bgColor} opacity-0 group-hover:opacity-100 rounded-3xl blur-xl transition-opacity -z-10`} />
                
                <div className={`w-14 h-14 bg-gradient-to-br ${stat.bgColor} rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-6 transition-transform`}>
                  <stat.icon className="text-white" size={28} />
                </div>

                <div className={`text-5xl font-black bg-gradient-to-r ${stat.color} bg-clip-text text-transparent mb-3 tracking-tight`}>
                  {stat.value}
                </div>
